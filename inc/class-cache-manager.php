...
class Cache_Manager {
     ...
     * @var string
     */
    private $index_option = 'slc_cache_index_keys';

    /**
     * コンストラクタ
     */
    private function __construct() {
        $this->expiration = get_option( 'slc_cache_expiration', SIMPLE_LINK_CARD_CACHE_EXPIRATION );
    }
    ...
    public function get( $url ) {
        ...
        if ( false !== $data && is_array( $data ) ) {
             ...
             */
            do_action( 'simple_link_card_cache_hit', $url, $key );
            return $data;
        }
        ...
        do_action( 'simple_link_card_cache_miss', $url, $key );
        return false;
    }
    ...
    public function set( $url, $data, $expiration = null ) {
        ...
        if ( $result ) {
             ...
             * @param int    $expiration 有効期限（秒）
             */
            do_action( 'simple_link_card_cache_set', $url, $key, $data, $expiration );
        }
    ...
    public function delete( $url ) {
        ...
        if ( $result ) {
             ...
             * @param string $key  キャッシュキー
             */
            do_action( 'simple_link_card_cache_deleted', $url, $key );
        }
    ...
    public function clear_all() {
         ...
         */
        do_action( 'simple_link_card_cache_cleared', $count );
    ...
    public function set_expiration( $expiration ) {
        ...
        update_option( 'slc_cache_expiration', $this->expiration );
    }
