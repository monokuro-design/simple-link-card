...
class RestApiTest extends TestCase {
    ...
    public function test_rate_limit_returns_error_when_exceeded() {
        ...
        set_transient('slc_rate_limit_' . $user_id, 30, MINUTE_IN_SECONDS);
    ...
    public function test_rate_limit_allows_requests_under_limit() {
        ...
        set_transient('slc_rate_limit_' . $user_id, 29, MINUTE_IN_SECONDS);
        ...
        $this->assertEquals(30, get_transient('slc_rate_limit_' . $user_id));
    }
}
