...
namespace Simple_Link_Card\Tests\Integration;

use PHPUnit\Framework\TestCase;
use Simple_Link_Card\Renderer;
...
class BlockRenderingTest extends TestCase {
    ...
    public function test_render_with_valid_url_returns_html() {
        ...
        $this->assertStringContainsString('wp-block-simple-link-card', $result);
        $this->assertStringContainsString('slc-card', $result);
    ...
    public function test_render_with_ogp_data_includes_expected_elements() {
        ...
        $this->assertStringContainsString('slc-card__title', $result);

        // Check for description
        $this->assertStringContainsString('This is a test description', $result);
        $this->assertStringContainsString('slc-card__description', $result);

        // Check for site name
        $this->assertStringContainsString('Example Site', $result);
        $this->assertStringContainsString('slc-card__site', $result);

        // Check for image
        $this->assertStringContainsString('https://example.com/image.jpg', $result);
        $this->assertStringContainsString('slc-card__image', $result);
    }
    ...
    public function test_render_with_right_image_position() {
        ...
        $this->assertStringContainsString('slc-card--image-right', $result);
    }
    ...
    public function test_render_with_hidden_image() {
        ...
        $this->assertStringContainsString('slc-card--no-image', $result);
    }
    ...
    public function test_render_without_description() {
        ...
        $this->assertStringNotContainsString('slc-card__description', $result);
    }
    ...
    public function test_render_without_site_name() {
        ...
        $this->assertStringNotContainsString('This should not be displayed', $result);
        $this->assertStringNotContainsString('slc-card__site', $result);
    }
    ...
    /**
     * Test simple_link_card_card_html filter is applied
     */
    public function test_card_html_filter_is_applied() {
        ...
        add_filter( 'simple_link_card_card_html', function( $html ) use ( &$filter_applied, &$filtered_html ) {
            $filter_applied = true;
            $filtered_html = $html;
    ...
    public function test_render_placeholder() {
        ...
        $this->assertStringContainsString('slc-placeholder', $result);
    ...
    public function test_render_error() {
        ...
        $this->assertStringContainsString('slc-error', $result);
    ...
    public function test_render_loading() {
        ...
        $this->assertStringContainsString('slc-loading', $result);
        $this->assertStringContainsString('slc-spinner', $result);
    }
